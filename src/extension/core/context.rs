...
impl HookContext {
    ...
    #[must_use]
    pub fn as_prompt_build(&self) -> Option<&crate::extension::types::PromptBuildState> {
        match &self.input {
    ...
    #[must_use]
    pub fn as_session_state(&self) -> Option<&crate::extension::types::SessionSnapshot> {
        match &self.input {
    ...
    #[must_use]
    pub fn as_message(&self) -> Option<&crate::extension::types::MessageEnvelope> {
        match &self.input {
