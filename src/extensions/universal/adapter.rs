...
impl UniversalToolAdapter {
    ...
    async fn find_executable(&self, tool_path: &Path, tool_name: &str) -> Option<PathBuf> {
        crate::extension::adapters::parsing::find_executable(tool_path, tool_name).await
    }
...
impl HookHandler for UniversalToolExecuteHandler {
    async fn handle(&self, ctx: HookContext) -> HookResult {
        ...
        let exec_config =
            crate::extension::services::ToolExecutionConfig::with_schema(self.full_schema.clone());
