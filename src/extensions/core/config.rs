...
use crate::extensions::types::{HookId};
...
pub struct ExtensionServices {
    ...
    async_router: crate::extensions::transport::AsyncExecutionRouter,
...
impl ExtensionServices {
    ...
    #[must_use]
    pub fn new() -> Self {
        Self::with_async_router(crate::extensions::transport::AsyncExecutionRouter::new())
    }
    ...
    pub fn async_router(&self) -> &crate::extensions::transport::AsyncExecutionRouter {
        &self.async_router
    }
