...
mod tests {
    ...
    fn sample_metadata(name: &str) -> ToolMetadata {
        ToolMetadata::new(
            ...
            crate::extensions::types::ToolSource::BuiltIn,
        )
    }
    ...
    async fn test_auto_async_handler() {
        ...
        let ctx = HookContext::new(
            ...
            crate::extensions::types::HookInput::ToolCall {
                tool_name: "test_tool".to_string(),
    ...
    async fn test_auto_status_handler() {
        ...
        let ctx = HookContext::new(
            ...
            crate::extensions::types::HookInput::TaskStatus {
    ...
    async fn test_auto_cancel_handler() {
        ...
        let ctx = HookContext::new(
            ...
            crate::extensions::types::HookInput::TaskCancel {
                task_id: "task-123".to_string(),
                tool_name: "test_tool".to_string(),
            },
            Arc::new(ExtensionServices::new()),
