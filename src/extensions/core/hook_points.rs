...
impl HookPoint {
    ...
    pub fn category(&self) -> &'static str {
        match self {
            Self::PromptSystemSection { .. } |
            Self::PromptPreProcess |
            Self::PromptPostProcess => "prompt",
            ...
            Self::SessionContextBuild => "session",
            ...
            Self::EventSubscribe { .. } |
            Self::EventEmit => "event",
            
            Self::AgentInit |
            Self::AgentShutdown |
            Self::AgentIteration { .. } => "agent",
        }
    }
...
impl HookPointBuilder {
    ...
    pub fn prompt_section_with_priority(
...
mod tests {
    ...
    fn test_hook_point_category() {
        ...
        assert_eq!(
            HookPoint::ToolRegister.category(),
            "tool"
        );
        
        assert_eq!(
            HookPoint::ChannelInput.category(),
            "io"
        );
    }
    ...
    fn test_common_hook_points() {
        ...
        assert!(matches!(tools, HookPoint::PromptSystemSection { section, .. } if section == "tools"));
    ...
    fn test_builder() {
        ...
        assert!(matches!(hp, HookPoint::PromptSystemSection { section, .. } if section == "custom"));
