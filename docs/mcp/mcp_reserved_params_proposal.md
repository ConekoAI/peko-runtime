...
| Runtime context injection | Low | Extend the framework `ReservedParamsService` (the resolver formerly shared with the universal-tool adapter, retired in ADR-062) |
