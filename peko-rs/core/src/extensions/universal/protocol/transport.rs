...
pub struct Transport {
    inner: crate::extensions::framework::protocols::shared::process_transport::ProcessTransport,
...
impl Transport {
    ...
    pub async fn spawn(executable: impl AsRef<std::path::Path>) -> Result<Self> {
        let inner =
            crate::extensions::framework::protocols::shared::process_transport::ProcessTransport::spawn_default(
                executable,
            )
            .await?;
