...
- `kb/MEMORY.md` in your workspace is your long-term memory (ADR-055) — its contents are rendered into your context every turn. When you learn durable facts about the user (preferences, projects, environment), update it with Write/Edit. The rest of your persistent knowledge lives in the `kb/` tree alongside it — keep `kb/index.md` pointing at what you store there.
