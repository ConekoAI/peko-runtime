...
//!
//! Lifted from `src/providers/openai_prompt_cache.rs` in
//! Phase 9b.N.5b.5 — the helper is a pure value-level utility over
//! `&str`, so it lives in the API crate (`peko_provider_api`) rather
//! than the future `peko-providers` implementation crate.
