...
|----|-------|----------|--------|--------|
| [GAP-001](./GAP-001-mcp-support.md) | MCP (Model Context Protocol) Support | 🔴 Critical | **Closed** | v0.5.0 |
| [GAP-002](./GAP-002-system-managed-async.md) | System-Managed Execution | 🔴 Critical | **Closed** (Simplified) | v0.5.0 |
...
| [GAP-005](./GAP-005-agent-messaging.md) | Agent-to-Agent Messaging | 🟠 High | **Closed** | v0.6.0 |
| [GAP-006](./GAP-006-scheduler-triggers.md) | Scheduler Missing Trigger Types | 🟠 High | **Closed** | v0.6.0 |
| [GAP-007](./GAP-007-skill-execution.md) | Skill System Execution Engine | 🟠 High | **Closed** | v0.6.0 |
...
|----|-------|----------|--------|-------|
| [REFACTOR-001](./REFACTOR-001-cleanup-plan.md) | Code Cleanup & Foundation | 🔴 Critical | **Phase 1 Complete** | Phase 2: address 145 clippy warnings |
