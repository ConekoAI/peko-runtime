...
try {
    ...
    try { & $pekoCmd team remove $teamName --force 2>&1 | Out-Null } catch {}
    try { & $pekoCmd team remove $importedTeam --force 2>&1 | Out-Null } catch {}
    try { & $pekoCmd team remove $noSessionTeam --force 2>&1 | Out-Null } catch {}
