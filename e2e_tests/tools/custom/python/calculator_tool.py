#!/usr/bin/env python3
"""Calculator tool using the Pekobot Tool SDK.

This tool demonstrates using the pekobot-tool package for creating
Universal Tools with context injection support.
"""
