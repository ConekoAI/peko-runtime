...
peko send $agentName "how many legs does a spider have?"--new 2>&1
...
peko session switch $agentName $sessionId1 2>&1
peko send $agentName "what about France" 2>&1
...
peko session switch $agentName $sessionId2 2>&1
peko send $agentName "what about a crab?" 2>&1
